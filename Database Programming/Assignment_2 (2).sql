REM Please refer to file "how to create the sample tables".
REM Simply copy the whole text in the script file, then paste to the worksheet 
REM in SQL developer, then (click the run button) run it.
REM steps: 
REM  open the script file and SQL developer, 
REM  Ctrl + a for the script file, then Ctrl + c
REM  Then highlight SQL Developer worksheet, Ctrl + v. Then click “run”
...
INSERT INTO locations VALUES ( 1200, '2017 Shinjuku-ku', '1689', 'Tokyo', 'Tokyo Pre', 'JP');
INSERT INTO locations VALUES ( 1300, '9450 Kamiya-cho', '6823', 'Hiroshima', NULL, 'JP');
INSERT INTO locations VALUES ( 1400, '2014 Jabberwocky Rd', '26192', 'Southlake', 'Texas', 'US');
INSERT INTO locations VALUES ( 1500, '2011 Interiors Blvd', '99236', 'San Francisco', 'California', 'US');
...
INSERT INTO locations VALUES ( 2200, '12-98 Victoria Street', '2901', 'Sydney', 'South Wales', 'AU');
INSERT INTO locations VALUES ( 2300, '198 Clementi North', '540198', 'Singapore', NULL, 'SG');
INSERT INTO locations VALUES ( 2400, '8204 Arthur St', NULL, 'London', NULL, 'UK');
INSERT INTO locations VALUES ( 2500, 'Magdalen Centre', 'OX9 9ZB', 'Oxford', 'Oxford', 'UK');
INSERT INTO locations VALUES ( 2600, '9702 Chester Road', '9850293', 'Stretford', 'Manchester', 'UK');
INSERT INTO locations VALUES ( 2700, 'Schwanthalerstr. 7031', '80925', 'Munich', 'Bavaria', 'DE');
INSERT INTO locations VALUES ( 2800, 'Rua Frei Caneca 1360 ', '01307-002', 'Sao Paulo', 'Sao Paulo', 'BR');
INSERT INTO locations VALUES ( 2900, '20 Rue des Corps-Saints', '1730', 'Geneva', 'Geneve', 'CH');
INSERT INTO locations VALUES ( 3000, 'Murtenstrasse 921', '3095', 'Bern', 'BE', 'CH');
INSERT INTO locations VALUES ( 3100, 'Pieter Breughelstraat 837', '3029SK', 'Utrecht', 'Utrecht', 'NL');
INSERT INTO locations VALUES ( 3200, 'Mariano Escobedo 9991', '11932', 'Mexico City', 'Federal,', 'MX'); 
...
COMMIT;
 ...
 REM script to create sample tables in Oracle
REM After you download this file to your local drive, you many simply copy the .txt file
REM then paste on SQL Develop work sheet and run it. 
...
DECLARE
    ...
    emp_fuName VARCHAR2(46);
    Sal employees.salary%TYPE;
BEGIN
    DBMS_OUTPUT.put_line  
        (' No     Emp No       Full Name                 salary');    
    DBMS_OUTPUT.put_line  
        ('-----  -------  ------------------------  ------------ ');

    FOR dummy_index IN c LOOP
        empid := dummy_index.employee_id;
        emp_fuName := dummy_index.Full_name;
        Sal := dummy_index.salary;

        DBMS_OUTPUT.put_line (RPAD (c%ROWCOUNT, 7) || RPAD (empid, 11) ||
            RPAD (emp_fuName, 25) || LPAD  (TO_CHAR (Sal, '$99,999'), 10 ));
    END LOOP;

    -- Add a COMMIT to force output
    COMMIT;
END;
/
--------------------OUTPUT-------------------------------------------------
...
No     Emp No       Full Name                 salary
-----  -------  ------------------------  ------------ 
1      128        Markle, Steven               $2,200
2      132        Olson, TJ                    $2,100
3      136        Philtanker, Hazel            $2,200
...
DECLARE
    ...
    increase NUMBER;
BEGIN
    DBMS_OUTPUT.put_line(' Employee-ID       Salary         Commission_PCT     Bonus');
    DBMS_OUTPUT.put_line('--------------    ----------     -----------------  ---------');

    FOR emp_record IN (SELECT employee_id, salary, commission_pct FROM employees WHERE department_id = dept_id) LOOP
        sal := emp_record.salary;
        comm := emp_record.commission_pct;
        ...
        -- Accumulate bonus
        total_bonus := total_bonus + increase;
    END LOOP;
...
-------------------OUTPUT-----------------------------------------------------
/*
Owner      Table Name             Column Name          Data Type        Data Length
---------- ---------------------- ---------------------- --------------- --------------
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                JIJOIN                KU$_JIJOIN_LIST64             
USER           EMPLOYEES                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           EMPLOYEES                ATTR_LIST             KU$_XSNSTMPL_AT64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                IND_SUBPART           KU$_IND_PART_T 0              
USER           EMPLOYEES                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                TXFM_SERIES_IDS       SDO_NUMBER_ARRA4408           
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                IMPL_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                PART_OBJ              KU$_IND_PARTOBJ0              
USER           EMPLOYEES                PARTITION_COL_NAMES   HSBLKNAMLST    64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                CS_BOUNDS             SDO_GEOMETRY   64             
USER           EMPLOYEES                QUERY_VCNT            KU$_VCNT       0              
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                PARTITION_LIST        KU$_10_1_PIND_S64             
USER           EMPLOYEES                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           EMPLOYEES                PARENT_LIST           KU$_XSSECCLSH_L64             
USER           EMPLOYEES                TRIGDEPS              KU$_TRIGGERDEP_64             
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           EMPLOYEES                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ELEMENT               XMLTYPE        64             
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
USER           EMPLOYEES                XSLT_DATA             XMLTYPE        64             
USER           EMPLOYEES                PART_OBJ              KU$_IOT_PARTOBJ0              
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                SUBPART               KU$_TAB_SUBPART0              
USER           EMPLOYEES                COLS                  KU$_TRIGGERCOL_64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                COL_LIST              KU$_TAB_COLUMN_64             
USER           EMPLOYEES                PLSQL                 KU$_PROCOBJ_LIN64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST64             
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                SCHEMA                XMLTYPE        64             
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SECOBJS               KU$_DOMIDX_2NDT64             
USER           EMPLOYEES                TEXTVCNT              KU$_VCNT       0              
USER           EMPLOYEES                IND_SUBPART           KU$_IND_PART_T 64             
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                OPERATORS             KU$_INDEXOP_LIS64             
USER           EMPLOYEES                JIJOIN                KU$_JIJOIN_LIST64             
USER           EMPLOYEES                SIMPLE_TYPE           XMLTYPE        64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PART_OBJ              KU$_IND_PARTOBJ0              
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                COL_LIST              KU$_INDEX_COL_L64             
USER           EMPLOYEES                IND_PART              KU$_IND_PART_T 0              
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST0              
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                SUBPART               KU$_TAB_SUBPART64             
USER           EMPLOYEES                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                IOV                   KU$_OV_TABLE_T 0              
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T64             
USER           EMPLOYEES                TYPEMD                KU$_SIMPLE_TYPE64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST64             
USER           EMPLOYEES                COL_LIST              KU$_TAB_COLUMN_64             
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                PART_OBJ              KU$_IND_PARTOBJ0              
USER           EMPLOYEES                SECURITY_CLASS_NS     XMLTYPE        64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T888            
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI64             
USER           EMPLOYEES                INHKEY_LIST           KU$_XSINSTINHKE64             
USER           EMPLOYEES                JIJOIN                KU$_JIJOIN_LIST64             
USER           EMPLOYEES                CUBETAB               KU$_CUBE_TAB_T 64             
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                GEOMETRY              SDO_GEOMETRY   64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                USER_DATA             SCHEDULER_FILEW1              
USER           EMPLOYEES                SUPERTYPE_OBJ         KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           EMPLOYEES                IOV                   KU$_OV_TABLE_T 0              
USER           EMPLOYEES                IOV                   KU$_OV_TABLE_T 0              
USER           EMPLOYEES                AFFINE_PARAMETERS     SDO_NUMBER_ARRA4408           
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                TABCLUSTER            KU$_TABCLUSTER_64             
USER           EMPLOYEES                SDO_ROOT_MBR          SDO_GEOMETRY   1              
USER           EMPLOYEES                MVIEW_TAB             KU$_TABLE_T    64             
USER           EMPLOYEES                METHOD_LIST           KU$_METHOD_LIST64             
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           EMPLOYEES                COLS                  KU$_TRIGGERCOL_64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                NOTIFICATION_CONTEXT  ANYDATA        64             
USER           EMPLOYEES                TABCLUSTER            KU$_TABCLUSTER_64             
USER           EMPLOYEES                FILESPEC              KU$_FILE_LIST_T64             
USER           EMPLOYEES                CNST_COL_LIST         KU$_TAB_COL_LIS64             
USER           EMPLOYEES                EXTTAB                KU$_EXTTAB_T   64             
USER           EMPLOYEES                OTHER_TABLE_NAMES     SDO_STRING_ARRA4408           
USER           EMPLOYEES                PLSQL                 KU$_PROCOBJ_LIN64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T0              
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                ELEMENT               XMLTYPE        64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                EXTTAB                KU$_EXTTAB_T   64             
...
USER           EMPLOYEES                EXTTAB                KU$_EXTTAB_T   64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                DOMIDX_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PART_OBJ              KU$_TAB_PARTOBJ64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                HEAD_ELEMENT          XMLTYPE        64             
USER           EMPLOYEES                PARAM_LIST            KU$_XSACLPARAM_64             
USER           EMPLOYEES                VALUE                 ANYDATA        4408           
USER           EMPLOYEES                CON2_LIST             KU$_CONSTRAINT264             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           EMPLOYEES                LVL_LIST              KU$_ATTR_DIM_LV64             
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           EMPLOYEES                BASE_IND_OBJ          KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ELEMENT               XMLTYPE        64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                DEFAULT_ANYDATA_VALUE ANYDATA        4408           
USER           EMPLOYEES                PACKAGE_BODY_T        KU$_PROC_T     64             
USER           EMPLOYEES                PARTITION_COL_TYPES   HSBLKNAMLST    16             
USER           EMPLOYEES                CON2_LIST             KU$_CONSTRAINT264             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                PCOL                  KU$_FGA_REL_COL64             
USER           EMPLOYEES                BLOCKMBR              SDO_GEOMETRY   1              
USER           EMPLOYEES                CUBETAB               KU$_CUBE_TAB_T 64             
USER           EMPLOYEES                IOV                   KU$_OV_TABLE_T 1440           
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
...
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_TAB_OBJ          KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PARTITION_COL_TYPES   HSBLKNAMLST    64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                WITH_OPTION           KU$_CONSTRAINT0360            
USER           EMPLOYEES                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                SRC_LIST              KU$_HCS_SRC_LIS64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T0              
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CACHE_MEAS_LIST       KU$_HCS_AV_CACH64             
USER           EMPLOYEES                AGGR_PRIV_LIST        KU$_XSAGGPRIV_L64             
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                IOV                   KU$_OV_TABLE_T 0              
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                MVIEW_TAB             KU$_TABLE_T    64             
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PRIV_LIST             KU$_XSPRIV_LIST64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           EMPLOYEES                PARSED_QUERY_TXT      XMLTYPE        64             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_IND_OBJ          KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST0              
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                BODY_VCNT             KU$_VCNT       0              
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                RULE_ACTION_CONTEXT   RE$NV_LIST     64             
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                JIJOIN                KU$_JIJOIN_LIST64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                BASE_TAB_OBJ          KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PART_OBJ              KU$_IND_PARTOBJ64             
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
USER           EMPLOYEES                CACHE_INFO            KU$_CACHED_STAT96             
USER           EMPLOYEES                PART_OBJ              KU$_TAB_PARTOBJ0              
USER           EMPLOYEES                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                TABCLUSTER            KU$_TABCLUSTER_64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T64             
USER           EMPLOYEES                PROXY_ROLE_LIST       KU$_PROXY_ROLE_64             
USER           EMPLOYEES                PARSED_DEF            KU$_SOURCE_T   64             
USER           EMPLOYEES                BINDINGS              KU$_OPBINDING_L64             
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST64             
USER           EMPLOYEES                TXFM_SERIES_IDS       SDO_NUMBER_ARRA4408           
USER           EMPLOYEES                PARSED_DEF            KU$_SOURCE_T   64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PART_OBJ              KU$_TAB_PARTOBJ0              
USER           EMPLOYEES                ROLE_LIST             KU$_DEFROLE_LIS64             
USER           EMPLOYEES                COL_LIST              KU$_SGI_COL_LIS64             
USER           EMPLOYEES                IDENTITY_COL          KU$_IDENTITY_CO64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SEQUENCE              KU$_SEQUENCE_T 64             
USER           EMPLOYEES                MVIEWLOG              KU$_M_VIEW_LOG_64             
USER           EMPLOYEES                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           EMPLOYEES                COL_LIST              KU$_TAB_COLUMN_64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                WITH_OPTION           KU$_CONSTRAINT0360            
USER           EMPLOYEES                INSTRULE              KU$_XSINST_RULE64             
USER           EMPLOYEES                TABCLUSTER            KU$_TABCLUSTER_64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BODY_VCNT             KU$_VCNT       0              
USER           EMPLOYEES                MVIEW_TAB             KU$_IO_TABLE_T 64             
...
USER           EMPLOYEES                HEAD_ELEMENT          XMLTYPE        64             
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                PROCEDUREINFO         KU$_PROCINFO_T 360            
USER           EMPLOYEES                MVIEW_TAB             KU$_TABLE_T    64             
USER           EMPLOYEES                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                JAVA_RESOURCE         KU$_JAVA_T     64             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
USER           EMPLOYEES                CLSFCTN_LIST          KU$_HCS_CLSFCTN64             
USER           EMPLOYEES                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           EMPLOYEES                CON2_LIST             KU$_CONSTRAINT264             
USER           EMPLOYEES                CLSFCTN_LIST          KU$_HCS_CLSFCTN64             
USER           EMPLOYEES                TABLESPACE            KU$_TABLESPACE_64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                PARTITION_COL_NAMES   HSBLKNAMLST    16             
USER           EMPLOYEES                PLSQL                 KU$_PROCOBJ_LIN64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FROM_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                ELEMENT               XMLTYPE        64             
USER           EMPLOYEES                STATS_OBJ             KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ATTRIBUTE             XMLTYPE        64             
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                PARAMETERS            XMLTYPE        64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                TABPART               KU$_TAB_PART_T 0              
USER           EMPLOYEES                COMPLEX_TYPE          XMLTYPE        64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                DEFAULT_ANYDATA_VALUE ANYDATA        4408           
USER           EMPLOYEES                INSTSET_LIST          KU$_XSINSTSET_L64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST64             
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CREDENTIAL            KU$_CREDENTIAL_64             
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                CON2_LIST             KU$_CONSTRAINT264             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                LEGACY_CS_BOUNDS      SDO_GEOMETRY   64             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
USER           EMPLOYEES                IOV                   KU$_OV_TABLE_T 0              
USER           EMPLOYEES                ACE_LIST              KU$_XSACE_LIST_64             
USER           EMPLOYEES                JOIN_PATH_LIST        KU$_HIER_JOIN_P64             
USER           EMPLOYEES                MEAS_LIST             KU$_ANALYTIC_VI64             
USER           EMPLOYEES                TABCLUSTER            KU$_TABCLUSTER_64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
USER           EMPLOYEES                CON1                  KU$_CONSTRAINT164             
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
USER           EMPLOYEES                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           EMPLOYEES                EXTENT                SDO_GEOMETRY   1              
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                PART_OBJ              KU$_TAB_PARTOBJ64             
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
USER           EMPLOYEES                BLK_EXTENT            SDO_GEOMETRY   1              
USER           EMPLOYEES                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                PARSED_DEF            KU$_SOURCE_T   64             
USER           EMPLOYEES                LOW_VALUE             HSBLKVALARY    4408           
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T0              
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                COL_LIST              KU$_TAB_COLUMN_64             
USER           EMPLOYEES                COL_LIST2             KU$_TAB_COLUMN_64             
USER           EMPLOYEES                IOV                   KU$_OV_TABLE_T 0              
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                RLS_ASSOC_LIST        KU$_RLS_ASSOC_L64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PACKAGE_T             KU$_PROC_T     64             
USER           EMPLOYEES                RLS_LIST              KU$_RLS_POLICY_64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CON0_LIST             KU$_CONSTRAINT064             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
...
USER           EMPLOYEES                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                HINTS                 KU$_OUTLINE_HIN64             
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           EMPLOYEES                COLUMN_LIST           KU$_TAB_COL_LIS64             
USER           EMPLOYEES                DOMIDX_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                IND_PART              KU$_IND_PART_T 0              
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                COL                   KU$_SIMPLE_COL_64             
USER           EMPLOYEES                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
...
USER           EMPLOYEES                MVIEWLOG              KU$_M_VIEW_LOG_64             
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                ACTION_STR            KU$_TACTION_LIS64             
USER           EMPLOYEES                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                PARSED_QUERY_TXT      XMLTYPE        64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                CS_BOUNDS             SDO_GEOMETRY   1              
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           EMPLOYEES                COL_LIST              KU$_SIMPLE_COL_64             
USER           EMPLOYEES                COL_LIST              KU$_INDEX_COL_L64             
USER           EMPLOYEES                HR_ATTR_LIST          KU$_HIER_HIER_A64             
USER           EMPLOYEES                TABCLUSTER            KU$_TABCLUSTER_64             
USER           EMPLOYEES                CON2_LIST             KU$_CONSTRAINT264             
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                MVIEW_TAB             KU$_TABLE_T    64             
...
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                CUBETAB               KU$_CUBE_TAB_T 64             
USER           EMPLOYEES                IND_PART              KU$_IND_PART_T 64             
USER           EMPLOYEES                CUBETAB               KU$_CUBE_TAB_T 64             
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST64             
USER           EMPLOYEES                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                IND_PART              KU$_IND_PART_T 0              
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                INST_INH              KU$_XSINSTINH_L64             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T0              
USER           EMPLOYEES                TYPEMD                KU$_SIMPLE_TYPE64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                SDO_ROOT_MBR          SDO_GEOMETRY   64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ANY_CONTEXT           ANYDATA        4408           
USER           EMPLOYEES                ANYDATA_VALUE         ANYDATA        64             
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                QUERY_VCNT            KU$_VCNT       0              
USER           EMPLOYEES                PROCPLSQL             KU$_PROCPLSQL_T96             
USER           EMPLOYEES                PROCC                 KU$_PROCC_T    96             
USER           EMPLOYEES                COL_LIST              KU$_INDEX_COL_L64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                COL_LIST              KU$_INDEX_COL_L64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
...
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CON0                  KU$_CONSTRAINT0360            
USER           EMPLOYEES                COL_LIST              KU$_TAB_COLUMN_64             
USER           EMPLOYEES                CUBETAB               KU$_CUBE_TAB_T 64             
USER           EMPLOYEES                XMLCOLSET             KU$_XMLCOLSET_T0              
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
USER           EMPLOYEES                EXTTAB                KU$_EXTTAB_T   64             
USER           EMPLOYEES                COL_LIST              KU$_TAB_COLUMN_64             
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
...
USER           EMPLOYEES                DOMIDX_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                COL_LIST              KU$_STRMCOL_LIS64             
USER           EMPLOYEES                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                INDARRAY              KU$_INDARRAYTYP64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BODY_VCNT             KU$_VCNT       0              
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
...
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SRT_LIST              KU$_M_VIEW_SRT_64             
USER           EMPLOYEES                MVIEW_TAB             KU$_TABLE_T    64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           EMPLOYEES                MVIEW                 KU$_M_VIEW_T   64             
USER           EMPLOYEES                MVIEWLOG_TAB          KU$_TABLE_T    64             
USER           EMPLOYEES                MVIEWLOG_TAB          KU$_TABLE_T    64             
USER           EMPLOYEES                XS_PRIN               KU$_XSPRIN_T   64             
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                ATTR_SEC_LIST         KU$_XSATTRSEC_L64             
USER           EMPLOYEES                OLAP_POLICY_LIST      KU$_XSOLAP_POLI64             
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                PROFILE_LIST          KU$_PROFILE_LIS64             
USER           EMPLOYEES                PROXY_ROLE_LIST       KU$_PROXY_ROLE_64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FUNC_VCNT             KU$_VCNT       0              
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                TO_OBJ                KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PTAB_INFO_LIST        KU$_PTAB_STATS_64             
USER           EMPLOYEES                BASE_IND_OBJ          KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_TAB_OBJ          KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PARTITION_LIST        KU$_PIND_STATS_64             
USER           EMPLOYEES                PLSQL                 KU$_PROCOBJ_LIN64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T0              
...
USER           EMPLOYEES                TABCLUSTER            KU$_TABCLUSTER_64             
USER           EMPLOYEES                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           EMPLOYEES                TABPART               KU$_TAB_PART_T 64             
USER           EMPLOYEES                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                EDN_TYPES             KU$_USER_EDITIO64             
USER           EMPLOYEES                HIGH_VALUE            HSBLKVALARY    4408           
USER           EMPLOYEES                PARTITION_COL_TYPES   HSBLKNAMLST    64             
USER           EMPLOYEES                ATTRIBUTE             XMLTYPE        64             
USER           EMPLOYEES                LEGACY_CS_BOUNDS      SDO_GEOMETRY   1              
USER           EMPLOYEES                BLK_DOMAIN            SDO_ORGSCL_TYPE1              
USER           EMPLOYEES                SCHEMA_DATA           XMLTYPE        64             
USER           EMPLOYEES                COMPONENT_OBJECT      WRI$_REPT_ABSTR64             
USER           EMPLOYEES                CL1                   DS_VARRAY_4_CLO64             
USER           EMPLOYEES                TABCLUSTER            KU$_TABCLUSTER_64             
USER           EMPLOYEES                EXTTAB                KU$_EXTTAB_T   64             
USER           EMPLOYEES                CUBETAB               KU$_CUBE_TAB_T 64             
USER           EMPLOYEES                STORAGE               KU$_STORAGE_T  536            
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                TYPE_T                KU$_TYPE_T     64             
USER           EMPLOYEES                TYPE_BODY_T           KU$_TYPE_BODY_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           EMPLOYEES                IND_PART              KU$_IND_PART_T 64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                CON2_LIST             KU$_CONSTRAINT264             
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                PART_OBJ              KU$_IOT_PARTOBJ64             
USER           EMPLOYEES                PKREF_LIST            KU$_PKREF_CONST64             
USER           EMPLOYEES                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
...
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                COL_LIST              KU$_10_2_STRMCO64             
USER           EMPLOYEES                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                COLS                  KU$_TRIGGERCOL_64             
...
USER           EMPLOYEES                PARSED_DEF            KU$_SOURCE_T   64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                NODES                 KU$_OUTLINE_NOD64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                RLS_ASSOC_LIST        KU$_RLS_ASSOC_L64             
USER           EMPLOYEES                QUERY_VCNT            KU$_VCNT       0              
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
...
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ROLE_LIST             KU$_XSOBJ_LIST_64             
USER           EMPLOYEES                PRIV_LIST             KU$_XSACEPRIV_L64             
USER           EMPLOYEES                INSTACL_LIST          KU$_XSINSTACL_L64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PART_OBJ              KU$_TAB_PARTOBJ64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                JAVA_RESOURCE         KU$_JAVA_T     64             
USER           EMPLOYEES                PTAB_INFO_LIST        KU$_PTAB_STATS_64             
USER           EMPLOYEES                TAB_INFO              KU$_10_1_TAB_PT64             
USER           EMPLOYEES                PTAB_INFO_LIST        KU$_10_1_PTAB_S64             
USER           EMPLOYEES                CACHE_INFO            KU$_CACHED_STAT96             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                UP_STATS_LIST         KU$_UP_STATS_LI64             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                ATTR_LIST             KU$_ATTR_DIM_AT64             
USER           EMPLOYEES                JOIN_PATH_LIST        KU$_ATTR_DIM_JO64             
USER           EMPLOYEES                LVL_LIST              KU$_HIER_LVL_LI64             
USER           EMPLOYEES                DIM_LIST              KU$_ANALYTIC_VI64             
USER           EMPLOYEES                VALUE                 ANYDATA        64             
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           EMPLOYEES                IOV                   KU$_OV_TABLE_T 0              
USER           EMPLOYEES                PART_OBJ              KU$_TAB_PARTOBJ0              
USER           EMPLOYEES                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           EMPLOYEES                PARENT_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                MAPTAB                KU$_MAP_TABLE_T0              
USER           EMPLOYEES                FBA                   KU$_FBA_T      336            
USER           EMPLOYEES                CLST                  KU$_CLST_T     64             
USER           EMPLOYEES                EXTTAB                KU$_EXTTAB_T   64             
...
USER           EMPLOYEES                NT                    KU$_NT_PARENT_T64             
USER           EMPLOYEES                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           EMPLOYEES                DATA                  XMLTYPE        64             
USER           EMPLOYEES                SECURITY_CLASS_NAME   XMLTYPE        64             
USER           EMPLOYEES                PRIVILEGE             XMLTYPE        64             
USER           EMPLOYEES                COMPLEX_TYPE          XMLTYPE        64             
USER           EMPLOYEES                DIMINFO               SDO_DIM_ARRAY  624            
USER           EMPLOYEES                GEOMETRY              SDO_GEOMETRY   64             
USER           EMPLOYEES                SDO_ROOT_MBR          SDO_GEOMETRY   64             
USER           EMPLOYEES                COL_LIST              KU$_TAB_COLUMN_64             
USER           EMPLOYEES                ANYDATA_VALUE         ANYDATA        64             
USER           EMPLOYEES                SRT_LIST              KU$_M_VIEW_SRT_64             
USER           EMPLOYEES                PROCJAVA              KU$_PROCJAVA_T 64             
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                COLLECTION            KU$_COLLECTION_64             
USER           EMPLOYEES                ATTR_LIST             KU$_TYPE_ATTR_L64             
USER           EMPLOYEES                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                LOCATION              KU$_EXTLOC_LIST64             
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                SECOBJS               KU$_DOMIDX_2NDT64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           EMPLOYEES                PARSED_TEXT           XMLTYPE        64             
USER           EMPLOYEES                PARSED_TEXT           XMLTYPE        64             
USER           EMPLOYEES                CON2_LIST             KU$_CONSTRAINT264             
USER           EMPLOYEES                SRT_LIST              KU$_M_VIEW_SRT_64             
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
...
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                XS_OBJ                KU$_XSOBJ_T    64             
USER           EMPLOYEES                XS_SCL                KU$_XSSCLASS_T 64             
USER           EMPLOYEES                REL_COLS              KU$_RLS_SEC_REL64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                COLUMN_LIST           KU$_TAB_COL_LIS64             
USER           EMPLOYEES                TAB_INFO              KU$_TAB_PTAB_ST64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PARTITION_LIST        KU$_PIND_STATS_64             
USER           EMPLOYEES                CNST_COL_LIST         KU$_TAB_COL_LIS64             
USER           EMPLOYEES                BASE_IND_OBJ          KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PARTITION_COL_NAMES   HSBLKNAMLST    64             
USER           EMPLOYEES                EXECUTION_PLAN        XMLTYPE        64             
USER           EMPLOYEES                GEOMETRY              SDO_GEOMETRY   64             
USER           EMPLOYEES                BLK_EXTENT            SDO_GEOMETRY   1              
USER           EMPLOYEES                OTHER_TABLE_NAMES     SDO_STRING_ARRA4408           
USER           EMPLOYEES                RULE_ACTION_CONTEXT   RE$NV_LIST     64             
...
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           EMPLOYEES                PARSED_QUERY_TXT      XMLTYPE        64             
USER           EMPLOYEES                COLL_TYPE             KU$_SIMPLE_TYPE64             
USER           EMPLOYEES                ARGUMENT_LIST         KU$_ARGUMENT_LI64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           EMPLOYEES                SECOBJS               KU$_DOMIDX_2NDT64             
USER           EMPLOYEES                DEFERRED_STG          KU$_DEFERRED_ST600            
...
USER           EMPLOYEES                IND_PART              KU$_IND_PART_T 0              
USER           EMPLOYEES                IND_SUBPART           KU$_IND_PART_T 0              
USER           EMPLOYEES                CON2                  KU$_CONSTRAINT264             
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                CON1_LIST             KU$_CONSTRAINT164             
USER           EMPLOYEES                ANC_OBJ               KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           EMPLOYEES                MVIEWLOG_TAB          KU$_TABLE_T    64             
USER           EMPLOYEES                XS_GRANT_LIST         KU$_XSRGRANT_LI64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                AUDIT_LIST            KU$_AUDIT_LIST_64             
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                STORAGE_CLAUSE        KU$_QTAB_STORAG64             
USER           EMPLOYEES                TAB_INFO              KU$_TAB_PTAB_ST64             
USER           EMPLOYEES                CNST_COL_LIST         KU$_TAB_COL_LIS64             
USER           EMPLOYEES                CACHE_INFO            KU$_CACHED_STAT96             
USER           EMPLOYEES                REF_CHILD             KU$_ADD_SNAP_LI64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                PLSQL                 KU$_PROCOBJ_LIN64             
USER           EMPLOYEES                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
...
USER           EMPLOYEES                OBJGRANT_LIST         KU$_OBJGRANT_LI64             
USER           EMPLOYEES                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           EMPLOYEES                USER_PROP             ANYDATA        3752           
USER           EMPLOYEES                SCHEMA                XMLTYPE        64             
USER           EMPLOYEES                PARAMETERS            XMLTYPE        64             
USER           EMPLOYEES                ELEMENT               XMLTYPE        64             
USER           EMPLOYEES                ELEMENT               XMLTYPE        64             
...
USER           EMPLOYEES                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           EMPLOYEES                BLOCKMBR              SDO_GEOMETRY   1              
USER           LOCATIONS                LEGACY_CS_BOUNDS      SDO_GEOMETRY   1              
USER           LOCATIONS                BLK_DOMAIN            SDO_ORGSCL_TYPE1              
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                DOMIDX_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BODY_VCNT             KU$_VCNT       0              
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEWLOG_TAB          KU$_TABLE_T    64             
USER           LOCATIONS                XS_OBJ                KU$_XSOBJ_T    64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T0              
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                OLAP_POLICY_LIST      KU$_XSOLAP_POLI64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                DOMIDX_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PART_OBJ              KU$_TAB_PARTOBJ64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           LOCATIONS                QUERY_VCNT            KU$_VCNT       0              
USER           LOCATIONS                PROCPLSQL             KU$_PROCPLSQL_T96             
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T0              
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T0              
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                PARTITION_LIST        KU$_PIND_STATS_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                HIGH_VALUE            HSBLKVALARY    4408           
USER           LOCATIONS                PARTITION_COL_TYPES   HSBLKNAMLST    64             
USER           LOCATIONS                COL_LIST              KU$_INDEX_COL_L64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
USER           LOCATIONS                DOMIDX_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                PROFILE_LIST          KU$_PROFILE_LIS64             
USER           LOCATIONS                ANYDATA_VALUE         ANYDATA        64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                DOMIDX_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                TO_OBJ                KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CS_BOUNDS             SDO_GEOMETRY   1              
USER           LOCATIONS                CON1                  KU$_CONSTRAINT164             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
USER           LOCATIONS                NT                    KU$_NT_PARENT_T0              
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T0              
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
USER           LOCATIONS                IOV                   KU$_OV_TABLE_T 0              
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
USER           LOCATIONS                PARSED_DEF            KU$_SOURCE_T   64             
USER           LOCATIONS                COLS                  KU$_TRIGGERCOL_64             
USER           LOCATIONS                MVIEWLOG              KU$_M_VIEW_LOG_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                HR_ATTR_LIST          KU$_HIER_HIER_A64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                PKREF_LIST            KU$_PKREF_CONST64             
USER           LOCATIONS                IND_PART              KU$_IND_PART_T 64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T0              
USER           LOCATIONS                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                RLS_LIST              KU$_RLS_POLICY_64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PACKAGE_T             KU$_PROC_T     64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ACTION_STR            KU$_TACTION_LIS64             
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           LOCATIONS                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
...
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                BASE_TAB_OBJ          KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PARSED_QUERY_TXT      XMLTYPE        64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                COLUMN_LIST           KU$_TAB_COL_LIS64             
USER           LOCATIONS                SDO_ROOT_MBR          SDO_GEOMETRY   64             
USER           LOCATIONS                AFFINE_PARAMETERS     SDO_NUMBER_ARRA4408           
USER           LOCATIONS                BLK_EXTENT            SDO_GEOMETRY   1              
USER           LOCATIONS                EXTENT                SDO_GEOMETRY   1              
USER           LOCATIONS                COL                   KU$_SIMPLE_COL_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
USER           LOCATIONS                PART_OBJ              KU$_TAB_PARTOBJ64             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                IOV                   KU$_OV_TABLE_T 1440           
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
USER           LOCATIONS                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                HINTS                 KU$_OUTLINE_HIN64             
USER           LOCATIONS                XS_OBJ                KU$_XSOBJ_T    64             
USER           LOCATIONS                INST_INH              KU$_XSINSTINH_L64             
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
...
USER           LOCATIONS                COL_LIST              KU$_INDEX_COL_L64             
USER           LOCATIONS                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           LOCATIONS                IND_PART              KU$_IND_PART_T 0              
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
...
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           LOCATIONS                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           LOCATIONS                COL_LIST              KU$_SIMPLE_COL_64             
USER           LOCATIONS                RLS_ASSOC_LIST        KU$_RLS_ASSOC_L64             
USER           LOCATIONS                LOW_VALUE             HSBLKVALARY    4408           
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                IND_PART              KU$_IND_PART_T 0              
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
...
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                TYPEMD                KU$_SIMPLE_TYPE64             
USER           LOCATIONS                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           LOCATIONS                COL_LIST2             KU$_TAB_COLUMN_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                LEGACY_CS_BOUNDS      SDO_GEOMETRY   64             
USER           LOCATIONS                TXFM_SERIES_IDS       SDO_NUMBER_ARRA4408           
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           LOCATIONS                SEQUENCE              KU$_SEQUENCE_T 64             
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
...
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                INSTRULE              KU$_XSINST_RULE64             
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CLSFCTN_LIST          KU$_HCS_CLSFCTN64             
USER           LOCATIONS                JOIN_PATH_LIST        KU$_HIER_JOIN_P64             
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                ELEMENT               XMLTYPE        64             
USER           LOCATIONS                ATTRIBUTE             XMLTYPE        64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                MEAS_LIST             KU$_ANALYTIC_VI64             
USER           LOCATIONS                PARTITION_COL_NAMES   HSBLKNAMLST    16             
USER           LOCATIONS                COMPLEX_TYPE          XMLTYPE        64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                HEAD_ELEMENT          XMLTYPE        64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                COL_LIST              KU$_SGI_COL_LIS64             
USER           LOCATIONS                JAVA_RESOURCE         KU$_JAVA_T     64             
USER           LOCATIONS                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           LOCATIONS                NT                    KU$_NT_PARENT_T64             
USER           LOCATIONS                PKREF_LIST            KU$_PKREF_CONST64             
USER           LOCATIONS                PART_OBJ              KU$_IOT_PARTOBJ0              
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                IND_SUBPART           KU$_IND_PART_T 0              
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                WITH_OPTION           KU$_CONSTRAINT0360            
USER           LOCATIONS                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           LOCATIONS                MVIEWLOG              KU$_M_VIEW_LOG_64             
USER           LOCATIONS                SIMPLE_TYPE           XMLTYPE        64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
USER           LOCATIONS                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           LOCATIONS                PART_OBJ              KU$_TAB_PARTOBJ0              
USER           LOCATIONS                NT                    KU$_NT_PARENT_T64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
...
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PARSED_DEF            KU$_SOURCE_T   64             
USER           LOCATIONS                ACE_LIST              KU$_XSACE_LIST_64             
USER           LOCATIONS                BASE_TAB_OBJ          KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CLSFCTN_LIST          KU$_HCS_CLSFCTN64             
USER           LOCATIONS                TABPART               KU$_TAB_PART_T 0              
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CREDENTIAL            KU$_CREDENTIAL_64             
USER           LOCATIONS                INSTSET_LIST          KU$_XSINSTSET_L64             
USER           LOCATIONS                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                BINDINGS              KU$_OPBINDING_L64             
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                IOV                   KU$_OV_TABLE_T 0              
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
USER           LOCATIONS                PROCEDUREINFO         KU$_PROCINFO_T 360            
USER           LOCATIONS                PART_OBJ              KU$_TAB_PARTOBJ0              
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                TABLESPACE            KU$_TABLESPACE_64             
USER           LOCATIONS                ROLE_LIST             KU$_DEFROLE_LIS64             
USER           LOCATIONS                STATS_OBJ             KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                DEFAULT_ANYDATA_VALUE ANYDATA        4408           
USER           LOCATIONS                JIJOIN                KU$_JIJOIN_LIST64             
USER           LOCATIONS                PART_OBJ              KU$_IND_PARTOBJ64             
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                PROXY_ROLE_LIST       KU$_PROXY_ROLE_64             
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           LOCATIONS                IDENTITY_COL          KU$_IDENTITY_CO64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                PARSED_DEF            KU$_SOURCE_T   64             
USER           LOCATIONS                BODY_VCNT             KU$_VCNT       0              
USER           LOCATIONS                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           LOCATIONS                FROM_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CACHE_INFO            KU$_CACHED_STAT96             
USER           LOCATIONS                PARAMETERS            XMLTYPE        64             
USER           LOCATIONS                AFFINE_PARAMETERS     SDO_NUMBER_ARRA4408           
USER           LOCATIONS                OTHER_TABLE_NAMES     SDO_STRING_ARRA4408           
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           LOCATIONS                PART_OBJ              KU$_TAB_PARTOBJ64             
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
...
USER           LOCATIONS                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           LOCATIONS                XS_OBJ                KU$_XSOBJ_T    64             
USER           LOCATIONS                PARAM_LIST            KU$_XSACLPARAM_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_IND_OBJ          KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SRC_LIST              KU$_HCS_SRC_LIS64             
USER           LOCATIONS                VALUE                 ANYDATA        4408           
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
USER           LOCATIONS                HEAD_ELEMENT          XMLTYPE        64             
...
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                XS_OBJ                KU$_XSOBJ_T    64             
USER           LOCATIONS                CACHE_MEAS_LIST       KU$_HCS_AV_CACH64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                PACKAGE_BODY_T        KU$_PROC_T     64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ELEMENT               XMLTYPE        64             
...
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                AGGR_PRIV_LIST        KU$_XSAGGPRIV_L64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PARTITION_COL_TYPES   HSBLKNAMLST    64             
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
...
USER           LOCATIONS                COLS                  KU$_TRIGGERCOL_64             
USER           LOCATIONS                PARSED_QUERY_TXT      XMLTYPE        64             
USER           LOCATIONS                NOTIFICATION_CONTEXT  ANYDATA        64             
USER           LOCATIONS                SDO_ROOT_MBR          SDO_GEOMETRY   1              
USER           LOCATIONS                BLOCKMBR              SDO_GEOMETRY   1              
USER           LOCATIONS                RULE_ACTION_CONTEXT   RE$NV_LIST     64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                PKREF_LIST            KU$_PKREF_CONST0              
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BODY_VCNT             KU$_VCNT       0              
USER           LOCATIONS                PRIV_LIST             KU$_XSPRIV_LIST64             
USER           LOCATIONS                CNST_COL_LIST         KU$_TAB_COL_LIS64             
USER           LOCATIONS                LVL_LIST              KU$_ATTR_DIM_LV64             
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
...
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                PARTITION_COL_TYPES   HSBLKNAMLST    16             
USER           LOCATIONS                ELEMENT               XMLTYPE        64             
USER           LOCATIONS                FILESPEC              KU$_FILE_LIST_T64             
USER           LOCATIONS                SUPERTYPE_OBJ         KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                METHOD_LIST           KU$_METHOD_LIST64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
...
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                WITH_OPTION           KU$_CONSTRAINT0360            
USER           LOCATIONS                PCOL                  KU$_FGA_REL_COL64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                BASE_TAB_OBJ          KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T64             
...
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                OPERATORS             KU$_INDEXOP_LIS64             
USER           LOCATIONS                COLS                  KU$_TRIGGERCOL_64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                PARENT_LIST           KU$_XSSECCLSH_L64             
USER           LOCATIONS                XS_OBJ                KU$_XSOBJ_T    64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
...
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                SUBPART               KU$_TAB_SUBPART64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                SECOBJS               KU$_DOMIDX_2NDT64             
USER           LOCATIONS                JIJOIN                KU$_JIJOIN_LIST64             
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                JIJOIN                KU$_JIJOIN_LIST64             
USER           LOCATIONS                ATTR_LIST             KU$_XSNSTMPL_AT64             
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
...
USER           LOCATIONS                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           LOCATIONS                IND_SUBPART           KU$_IND_PART_T 0              
USER           LOCATIONS                IND_SUBPART           KU$_IND_PART_T 64             
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                PKREF_LIST            KU$_PKREF_CONST64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                USER_DATA             SCHEDULER_FILEW1              
USER           LOCATIONS                XSLT_DATA             XMLTYPE        64             
USER           LOCATIONS                QUERY_VCNT            KU$_VCNT       0              
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           LOCATIONS                CS_BOUNDS             SDO_GEOMETRY   64             
USER           LOCATIONS                TXFM_SERIES_IDS       SDO_NUMBER_ARRA4408           
USER           LOCATIONS                GEOMETRY              SDO_GEOMETRY   64             
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           LOCATIONS                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                NT                    KU$_NT_PARENT_T64             
USER           LOCATIONS                PKREF_LIST            KU$_PKREF_CONST64             
USER           LOCATIONS                IMPL_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                XS_OBJ                KU$_XSOBJ_T    64             
USER           LOCATIONS                PARTITION_LIST        KU$_10_1_PIND_S64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           LOCATIONS                SUBPART               KU$_TAB_SUBPART0              
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                ELEMENT               XMLTYPE        64             
USER           LOCATIONS                SIMPLE_TYPE           XMLTYPE        64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                COL_LIST              KU$_INDEX_COL_L64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PART_OBJ              KU$_IND_PARTOBJ0              
USER           LOCATIONS                SECURITY_CLASS_NS     XMLTYPE        64             
USER           LOCATIONS                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI64             
USER           LOCATIONS                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
...
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                TEXTVCNT              KU$_VCNT       0              
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                PARTITION_COL_NAMES   HSBLKNAMLST    64             
USER           LOCATIONS                SCHEMA                XMLTYPE        64             
USER           LOCATIONS                IND_PART              KU$_IND_PART_T 0              
USER           LOCATIONS                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           LOCATIONS                PART_OBJ              KU$_IND_PARTOBJ0              
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T888            
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                INHKEY_LIST           KU$_XSINSTINHKE64             
USER           LOCATIONS                IM_COLSEL             KU$_IM_COLSEL_L64             
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T0              
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                JIJOIN                KU$_JIJOIN_LIST64             
USER           LOCATIONS                PART_OBJ              KU$_IND_PARTOBJ0              
USER           LOCATIONS                TRIGDEPS              KU$_TRIGGERDEP_64             
USER           LOCATIONS                GEOMETRY              SDO_GEOMETRY   64             
USER           LOCATIONS                IOV                   KU$_OV_TABLE_T 0              
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
...
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                PART_OBJ              KU$_IOT_PARTOBJ64             
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           LOCATIONS                COLS                  KU$_TRIGGERCOL_64             
USER           LOCATIONS                TRIGDEPS              KU$_TRIGGERDEP_64             
USER           LOCATIONS                PARSED_DEF            KU$_SOURCE_T   64             
USER           LOCATIONS                NODES                 KU$_OUTLINE_NOD64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                PART_OBJ              KU$_TAB_PARTOBJ64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                UP_STATS_LIST         KU$_UP_STATS_LI64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ATTR_LIST             KU$_ATTR_DIM_AT64             
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                NT                    KU$_NT_PARENT_T64             
USER           LOCATIONS                PKREF_LIST            KU$_PKREF_CONST64             
USER           LOCATIONS                DIM_LIST              KU$_ANALYTIC_VI64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                IND_SUBPART           KU$_IND_PART_T 0              
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                RLS_ASSOC_LIST        KU$_RLS_ASSOC_L64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PARENT_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                COMPLEX_TYPE          XMLTYPE        64             
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T0              
...
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PTAB_INFO_LIST        KU$_10_1_PTAB_S64             
USER           LOCATIONS                PRIVILEGE             XMLTYPE        64             
USER           LOCATIONS                TYPE_BODY_T           KU$_TYPE_BODY_T64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
...
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           LOCATIONS                DIMINFO               SDO_DIM_ARRAY  624            
USER           LOCATIONS                SDO_ROOT_MBR          SDO_GEOMETRY   64             
USER           LOCATIONS                COMPONENT_OBJECT      WRI$_REPT_ABSTR64             
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CON0_LIST             KU$_CONSTRAINT064             
USER           LOCATIONS                CON1_LIST             KU$_CONSTRAINT164             
...
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                ROLE_LIST             KU$_XSOBJ_LIST_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                JAVA_RESOURCE         KU$_JAVA_T     64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                JOIN_PATH_LIST        KU$_ATTR_DIM_JO64             
USER           LOCATIONS                LVL_LIST              KU$_HIER_LVL_LI64             
USER           LOCATIONS                VALUE                 ANYDATA        64             
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI64             
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
...
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                NT                    KU$_NT_PARENT_T64             
USER           LOCATIONS                DATA                  XMLTYPE        64             
USER           LOCATIONS                CL1                   DS_VARRAY_4_CLO64             
USER           LOCATIONS                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SECURITY_CLASS_NAME   XMLTYPE        64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                SECOBJS               KU$_DOMIDX_2NDT64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
...
USER           LOCATIONS                QUERY_VCNT            KU$_VCNT       0              
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                TAB_INFO              KU$_10_1_TAB_PT64             
USER           LOCATIONS                CACHE_INFO            KU$_CACHED_STAT96             
USER           LOCATIONS                SCHEMA_DATA           XMLTYPE        64             
USER           LOCATIONS                TYPE_T                KU$_TYPE_T     64             
USER           LOCATIONS                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           LOCATIONS                TABCLUSTER            KU$_TABCLUSTER_64             
USER           LOCATIONS                DOMIDX_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PRIV_LIST             KU$_XSACEPRIV_L64             
USER           LOCATIONS                INSTACL_LIST          KU$_XSINSTACL_L64             
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           LOCATIONS                PART_OBJ              KU$_TAB_PARTOBJ0              
USER           LOCATIONS                IND_PART              KU$_IND_PART_T 64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                COL_LIST              KU$_10_2_STRMCO64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                PTAB_INFO_LIST        KU$_PTAB_STATS_64             
USER           LOCATIONS                BLK_EXTENT            SDO_GEOMETRY   1              
USER           LOCATIONS                OTHER_TABLE_NAMES     SDO_STRING_ARRA4408           
USER           LOCATIONS                LOCATION              KU$_EXTLOC_LIST64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T0              
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
...
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                XS_OBJ                KU$_XSOBJ_T    64             
USER           LOCATIONS                XS_SCL                KU$_XSSCLASS_T 64             
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
USER           LOCATIONS                PLSQL_CODE            KU$_DOMIDX_PLSQ64             
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEWLOG_TAB          KU$_TABLE_T    64             
USER           LOCATIONS                EXECUTION_PLAN        XMLTYPE        64             
USER           LOCATIONS                COLLECTION            KU$_COLLECTION_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PART_OBJ              KU$_IND_PARTOBJ64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ANYDATA_VALUE         ANYDATA        64             
...
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                PARSED_TEXT           XMLTYPE        64             
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                MVIEW_TAB             KU$_IO_TABLE_T 64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                REL_COLS              KU$_RLS_SEC_REL64             
USER           LOCATIONS                ACTION_STR            KU$_TACTION_LIS64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PARTITION_COL_NAMES   HSBLKNAMLST    64             
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
...
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEWLOG              KU$_M_VIEW_LOG_64             
USER           LOCATIONS                TAB_INFO              KU$_TAB_PTAB_ST64             
USER           LOCATIONS                CNST_COL_LIST         KU$_TAB_COL_LIS64             
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                GEOMETRY              SDO_GEOMETRY   64             
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
...
USER           LOCATIONS                MVIEWLOG              KU$_M_VIEW_LOG_64             
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                ATTR_LIST             KU$_TYPE_ATTR_L64             
USER           LOCATIONS                SOURCE_LINES          KU$_SOURCE_LIST64             
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                JAVA_RESOURCE         KU$_JAVA_T     64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                SRT_LIST              KU$_M_VIEW_SRT_64             
USER           LOCATIONS                PROCJAVA              KU$_PROCJAVA_T 64             
USER           LOCATIONS                PKREF_LIST            KU$_PKREF_CONST0              
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                PKREF_LIST            KU$_PKREF_CONST0              
USER           LOCATIONS                OBJGRANT_LIST         KU$_OBJGRANT_LI0              
...
USER           LOCATIONS                SRT_LIST              KU$_M_VIEW_SRT_64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                XS_PRIN               KU$_XSPRIN_T   64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                PARTITION_LIST        KU$_PIND_STATS_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CON2                  KU$_CONSTRAINT264             
USER           LOCATIONS                PARENT_OBJ            KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T0              
USER           LOCATIONS                IOV                   KU$_OV_TABLE_T 0              
...
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                XS_GRANT_LIST         KU$_XSRGRANT_LI64             
USER           LOCATIONS                TAB_INFO              KU$_TAB_PTAB_ST64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                NT                    KU$_NT_PARENT_T64             
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
...
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                FBA_PERIODS           KU$_FBA_PERIOD_64             
USER           LOCATIONS                USER_PROP             ANYDATA        3752           
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                TEXTVCNT              KU$_VCNT       0              
USER           LOCATIONS                SRT_LIST              KU$_M_VIEW_SRT_64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
...
USER           LOCATIONS                BLK_DOMAIN            SDO_ORGSCL_TYPE1              
USER           LOCATIONS                BLOCKMBR              SDO_GEOMETRY   1              
USER           LOCATIONS                COLL_TYPE             KU$_SIMPLE_TYPE64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ILM_POLICIES          KU$_ILM_POLICY_64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
...
USER           LOCATIONS                MVIEW                 KU$_M_VIEW_T   64             
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
USER           LOCATIONS                AUDIT_LIST            KU$_AUDIT_LIST_64             
USER           LOCATIONS                CACHE_INFO            KU$_CACHED_STAT96             
USER           LOCATIONS                REF_CHILD             KU$_ADD_SNAP_LI64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T0              
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
...
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                PARSED_QUERY_TXT      XMLTYPE        64             
USER           LOCATIONS                ARGUMENT_LIST         KU$_ARGUMENT_LI64             
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
USER           LOCATIONS                CLST                  KU$_CLST_T     64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                CON2_LIST             KU$_CONSTRAINT264             
...
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                STORAGE_CLAUSE        KU$_QTAB_STORAG64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                RULE_ACTION_CONTEXT   RE$NV_LIST     64             
USER           LOCATIONS                JIJOIN_TABS           KU$_JIJOIN_TABL64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
...
USER           LOCATIONS                MVIEWLOG_TAB          KU$_TABLE_T    64             
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                CON0                  KU$_CONSTRAINT0360            
USER           LOCATIONS                EXTTAB                KU$_EXTTAB_T   64             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T0              
USER           LOCATIONS                FBA                   KU$_FBA_T      336            
...
USER           LOCATIONS                MAPTAB                KU$_MAP_TABLE_T888            
USER           LOCATIONS                IOV                   KU$_OV_TABLE_T 1440           
USER           LOCATIONS                COL_LIST              KU$_STRMCOL_LIS64             
USER           LOCATIONS                INDARRAY              KU$_INDARRAYTYP64             
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                COMPILER_INFO         KU$_SWITCH_COMP64             
USER           LOCATIONS                BODY_VCNT             KU$_VCNT       0              
USER           LOCATIONS                MVIEW_TAB             KU$_TABLE_T    64             
...
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                FUNC_VCNT             KU$_VCNT       0              
USER           LOCATIONS                PTAB_INFO_LIST        KU$_PTAB_STATS_64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                TABPART               KU$_TAB_PART_T 64             
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           LOCATIONS                IND_SUBPART           KU$_IND_PART_T 0              
USER           LOCATIONS                PART_OBJ              KU$_IND_PARTOBJ64             
USER           LOCATIONS                ATTR_SEC_LIST         KU$_XSATTRSEC_L64             
USER           LOCATIONS                CLSFCTN_LIST          KU$_HCS_CLSFCTN64             
USER           LOCATIONS                ATTRIBUTE             XMLTYPE        64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                DEFERRED_STG          KU$_DEFERRED_ST600            
...
USER           LOCATIONS                XS_OBJ                KU$_XSOBJ_T    64             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
USER           LOCATIONS                PROCC                 KU$_PROCC_T    96             
USER           LOCATIONS                COL_LIST              KU$_TAB_COLUMN_64             
USER           LOCATIONS                CUBETAB               KU$_CUBE_TAB_T 64             
USER           LOCATIONS                XMLCOLSET             KU$_XMLCOLSET_T64             
USER           LOCATIONS                SCHEMA_OBJ            KU$_SCHEMAOBJ_T64             
...
USER           LOCATIONS                PLSQL                 KU$_PROCOBJ_LIN64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T0              
USER           LOCATIONS                ANY_CONTEXT           ANYDATA        4408           
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                BASE_OBJ              KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                ANC_OBJ               KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                MVIEW_IDX_LIST        KU$_INDEX_LIST_64             
USER           LOCATIONS                BASE_IND_OBJ          KU$_SCHEMAOBJ_T64             
USER           LOCATIONS                EDN_TYPES             KU$_USER_EDITIO64             
USER           LOCATIONS                COL_LIST              KU$_INDEX_COL_L64             
USER           LOCATIONS                STORAGE               KU$_STORAGE_T  536            
USER           LOCATIONS                SECOBJS               KU$_DOMIDX_2NDT64             
USER           LOCATIONS                MVIEWLOG_TAB          KU$_TABLE_T    64             
...
Employee-ID       Salary         Commission_PCT     Bonus
--------------    ----------     -----------------  ---------
145          14000    .4                1300    
146          13500    .3                1300    
147          12000    .3                1300    
...
DECLARE
    ...
    CURSOR column_cursor (owner_name VARCHAR2, table_name VARCHAR2) IS
        SELECT column_name, data_type, data_length
        FROM all_tab_columns
        WHERE owner = data_type_owner AND table_name = table_name;
...
BEGIN
    ...
    OPEN column_cursor(owner_name, table_name);

    DBMS_OUTPUT.put_line('Owner      Table Name             Column Name          Data Type        Data Length');
    DBMS_OUTPUT.put_line('---------- ---------------------- ---------------------- --------------- --------------');

    -- Fetch and print column information
    LOOP
        FETCH column_cursor INTO v_column_name, v_data_type, v_data_length;
        EXIT WHEN column_cursor%NOTFOUND;

        DBMS_OUTPUT.put_line(
            RPAD(owner_name, 15) ||
            RPAD(table_name, 25) ||
            RPAD(v_column_name, 22) ||
            RPAD(v_data_type, 15) ||
            RPAD(v_data_length, 15)
        );
    END LOOP;

    CLOSE column_cursor;

    -- Open cursor for 'LOCATIONS'
    owner_name := 'USER';
...
DECLARE
    ...
    empno temp_emp.empno%TYPE;
    ename temp_emp.ename%TYPE;
    salary temp_emp.sal%TYPE;
    deptno temp_emp.deptno%TYPE;

BEGIN
    OPEN update_cursor;

    LOOP
        FETCH update_cursor INTO empno, ename, salary, deptno;
        ...
        IF salary < 1500 THEN
            ...
            -- Print information about the affected employee
            DBMS_OUTPUT.put_line('Employee ID: ' || empno);
            DBMS_OUTPUT.put_line('Employee Name: ' || ename);
            DBMS_OUTPUT.put_line('Old Salary: ' || TO_CHAR(salary / 1.1, '$999,999'));
            DBMS_OUTPUT.put_line('New Salary: ' || TO_CHAR(salary, '$999,999'));
            DBMS_OUTPUT.put_line('--------------------------');
        END IF;
    END LOOP;
...
DECLARE
    ...
    emp_salary employees.salary%TYPE; -- Added variable for salary
...
BEGIN
    ...
    LOOP
        ...
        DBMS_OUTPUT.PUT_LINE('Employee ID: ' || emp_record.employee_id || ', Full Name: ' || emp_record.first_name || ' ' || emp_record.last_name);
    END LOOP;
    ...
    OPEN emp_cursor FOR
        SELECT *
        FROM employees
        WHERE commission_pct >= 0.3 AND salary >= 12000
    ...
    LOOP
        ...
        DBMS_OUTPUT.PUT_LINE('Employee ID: ' || emp_record.employee_id ||
                              ...
                              ', Salary: ' || TO_CHAR(emp_salary, '$999,999') ||
                              ', Commission Rate: ' || emp_record.commission_pct);
    END LOOP;
...
--Output--
/*
Employee ID: 202, Full Name: Pat Fay
Employee ID: 201, Full Name: Michael Hartstein
Employee ID: 145, First Name: John, Last Name: Russell, Salary:   $14,000, Commission Rate: .4
Employee ID: 146, First Name: Karen, Last Name: Partners, Salary:   $13,500, Commission Rate: .3
Employee ID: 147, First Name: Alberto, Last Name: Errazuriz, Salary:   $12,000, Commission Rate: .3
*/
